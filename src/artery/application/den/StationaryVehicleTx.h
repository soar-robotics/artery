...
#ifndef ARTERY_STATIONARYVEHICLETX_H_QRTLCYIY
#define ARTERY_STATIONARYVEHICLETX_H_QRTLCYIY
...
class StationaryVehicleTx : public SuspendableUseCase//, public ItsG5Service
{
public:
    void check() override;
...
#endif /* ARTERY_STATIONARYVEHICLETX_H_QRTLCYIY */
