...
#include "artery/application/den/ForwardCollisionWarning.h"
...
Define_Module(ForwardCollisionWarning)
...
void ForwardCollisionWarning::initialize(int stage)
{
...
void ForwardCollisionWarning::check()
{
...
bool ForwardCollisionWarning::checkConditions()
{
    return checkEgoSpeed() && checkEgoDeceleration();
}

bool ForwardCollisionWarning::checkEgoSpeed() const
{
    return mVdp->speed() > mSpeedThreshold;
}

bool ForwardCollisionWarning::checkEgoDeceleration() const
{
...
vanetza::asn1::Denm ForwardCollisionWarning::createMessage()
{
...
vanetza::btp::DataRequestB ForwardCollisionWarning::createRequest()
{
...
void ForwardCollisionWarning::indicate(const artery::DenmObject& denm)
{
    ...
    if (denm & CauseCode::StationaryVehicle) {
        ...
        fcwHeading = asn1->denm.location->eventPositionHeading->headingValue / 10;
        distance = utils->distance(latitude/anglePrecision, longitude/anglePrecision,
        latit_1/anglePrecision, longi_1/anglePrecision);
        std::cout<<"EVV heading "<<fcwHeading<< " host heading "<<hvHeading
        ...
        */
        ...
        else if (static_cast<uint16_t>(abs(fcwHeading- hvHeading)) < BEARING_COMPENSATION &&
...
void ForwardCollisionWarning::handleStoryboardTrigger(const StoryboardSignal& signal)
{
